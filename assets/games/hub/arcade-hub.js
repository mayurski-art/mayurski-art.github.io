/* ARCADE HUB — account sync for the top-bar profile card + footer stats.
   Self-contained, no globals beyond binding to elements already in the DOM.
   The game grid itself is a plain static CSS grid (arcade-hub.css) — no JS
   needed to lay it out. */
(() => {
  "use strict";
