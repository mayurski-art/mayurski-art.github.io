...
/* Crops are [cx, cy, zoom]: the centre of the crop as a fraction of the
...
export const SKINS = [
  ...
  },
  {
    ...
    crops: {
      upper: [0.5, 0.47, 1.0],
      lower: [0.53, 0.5, 0.5],
      handguard: [0.205, 0.44, 0.35],
      stock: [0.65, 0.83, 0.2],
      grip: [0.96, 0.24, 0.065],
      mag: [0.76, 0.47, 0.125],
    },
